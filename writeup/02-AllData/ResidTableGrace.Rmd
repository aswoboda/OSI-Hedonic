...
```{r, cache=FALSE}
ResidTable=("~/OSI-Hedonic Project/Data/R2GIS/ResidTable.dbf")
ModelResids=resid(osiModel05int)
#PIN <-c(seq(start=0, to=51453, by=1, lengh.out=5, along.with=5))
#Coef<-c(coef(osiModel05int))
#Resid<-c(ModelResids)
ResidFrame=as.data.frame(resid(osiModel05int))
